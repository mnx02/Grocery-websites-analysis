...
public class TestCompare {
	public static void main(String[] args) {
		...
		String collectionfile = "C:\\Users\\Manav\\Downloads\\collections.txt";
		// Pattern for collection file.[1]
		String patternForCollection = "(.*?),.*?(\\$\\d+\\.\\d{2})";

		// this is the path for yupik website file.
		String yupikfile = "C:\\Users\\Manav\\Downloads\\yupik.txt";
		// Pattern for yupik website file.[1]
		String patternForYupik = "(.+?)[,:].*?(\\$\\d+\\.\\d{2})";
